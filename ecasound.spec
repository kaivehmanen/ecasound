...
%prep
%setup -n ecasound-METAVERSION
%build
./configure --prefix=$RPM_BUILD_ROOT%prefix --disable-static
make
...
/usr/local/bin/ecatools_fixdc
/usr/local/bin/ecatools_normalize
/usr/local/bin/ecatools_play

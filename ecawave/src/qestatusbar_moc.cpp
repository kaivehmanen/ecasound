...
**
** Created: Fri Mar 31 13:10:35 2000
...
void QEStatusBar::staticMetaObject()
{
    ...
    typedef void(QEStatusBar::*m1_t4)(const string&);
    typedef void(QEStatusBar::*m1_t5)();
    ...
    m1_t4 v1_4 = Q_AMPERSAND QEStatusBar::filename;
    m1_t5 v1_5 = Q_AMPERSAND QEStatusBar::update;
    ...
    slot_tbl[4].name = "filename(const string&)";
    slot_tbl[5].name = "update()";

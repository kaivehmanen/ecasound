// ------------------------------------------------------------------------
// qefadeoutevent.cpp: Fade-out effect
...
QEFadeOutEvent::QEFadeOutEvent(ECA_CONTROLLER* ctrl,
			       const string& input,
			       const string& output,
			       long int start_pos, 
			       long int length) 
  ...
  ectrl->add_controller("-kl:1,100,1," + kvu_numtostr(fade_length, 32));
}
